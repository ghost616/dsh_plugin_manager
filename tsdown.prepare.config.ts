 ...
 * source clone can produce runnable lib/index.js + lib/client.js + the
 * composable lib/control.js sub-entry after a pnpm git install (see README "Installing from a git host").
 */
export default [
